      ...
      >
        ...
        >
          <p className="small-p">
            ...
            stories have fascinated me, fueling my imagination and creativity.
            At the same time, the elegance and functionality of well-designed
            ...
            felt. With a strong foundation in <b>computer science</b>, and a
            rich background in various <b>programming languages</b> and{" "}
        ...
        >
          <p className="small-p">
            ...
            <b>
              {" "}
              currently pursuing a Bachelor of Engineering in Computer Science
              and Design{" "}
            </b>{" "}
            ...
            <br />
            <br />
            During my time at SUTD, I have worked on several significant
            projects that have sharpened my technical abilities. For instance, I
            developed a full-stack Android application called{" "}
            <b>LeftoverChef</b> using <b>Java and XML</b> to reduce food wastage
            by suggesting recipes for leftover ingredients. This project
            involved implementing advanced photo analysis capabilities and
            ingredient recognition using <b>YoloV5 and TensorFlow</b>, and
            integrating OpenAI and Google Search APIs to generate recipe
            suggestions. The backend was powered by <b>Firebase</b>, ensuring
            real-time data storage and retrieval, and the development was
            managed with Git for version control and teamwork. This project
            earned an <b>Honorable Mention and a $1,000 prize</b> at the Singtel
            Information Systems and Programming Merit Award for innovative use
            of technology in combating food waste.
            <br />
            <br />
            ...
            . My experience with tools like <b>Google Cloud, and Git </b> has
            also further enhanced my ability to tackle complex challenges in the
            tech industry.
          </p>
        </TabPane>
        <TabPane
        ...
        >
          <p className="small-p">
            ...
            lakes and mountains of Switzerland, or the vibrant cities and
            tranquil temples of Japan, each destination provides unique
            opportunities for creative expression through photography.
          </p>
        </TabPane>
      </Tabs>
    </>
